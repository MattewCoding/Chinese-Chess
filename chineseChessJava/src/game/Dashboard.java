...
public class Dashboard extends JPanel implements MouseListener{
     ...
     * @param the list of the captured pieces, the x and y are the initial coordinates and the xInitial is also the initial x-coordinate that will be compared to add the x coordinate to the next line
